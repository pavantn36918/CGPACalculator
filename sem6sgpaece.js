function calculate() {
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', '21EC61', 'Technology Innovation Management and Enterpreneurship', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', '21EC62', 'Microwave Theory & Antennas', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', '21EC63', 'VLSI Design & Testing', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', '21EC64x', 'Professional Elective Course-I', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', '21EC65x', 'Open Elective Course-I', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
                ['6', '21ECL66', 'VLSI Laboratory', a[5], b[5], gpl[5], lgl[5], b[5] * gpl[5]],
                ['7', '21ECMP67', 'Mini Project', a[6], b[6], gpl[6], lgl[6], b[6] * gpl[6]],
