function calculate() {
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', 'BCS301', 'Mathematics For Computer Science', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', 'BCS302', 'Digital Design and Computer Organization', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', 'BCS303', 'Operating Systems', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', 'BCS304', 'Data Structures and Applications', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', 'BCSL305', 'Data Structures Lab', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
