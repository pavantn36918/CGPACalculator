function calculate() {
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', '21CS71', 'Big Data Analytics', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', '21CS72', 'Cloud Computing', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', '21XX73X', 'Professional Elective Course-II (IOT)', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', '21XX74x', 'Professional Elective Course-III (Deep Learning)', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', '21XX75x', 'Open Elective', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
                ['6', '21CSP76', 'Project Work', a[5], b[5], gpl[5], lgl[5], b[5] * gpl[5]],
