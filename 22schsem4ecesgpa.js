function calculate() {
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', 'BEC401', 'Electromagnetics Theory', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', 'BEC402', 'Principles of Communication Systems', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', 'BEC403', 'Control Systems', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', 'BECL404', 'Communication Lab', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', 'BEC405x', 'ESC / ETC / PLC', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
                ['6', 'BXX456x', 'Ability Enhancement Course', a[5], b[5], gpl[5], lgl[5], b[5] * gpl[5]],
