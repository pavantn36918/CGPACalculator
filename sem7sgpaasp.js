function calculate() {
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', '21AS71', 'Conjugate Heat Transfer', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', '21AS72', 'Global Navigation Satellite Systems', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', '21AS72X', 'Professional Elective Course-II', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', '21AS73X', 'Professional Elective Course-III', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', '21XX75x', 'Open Elective', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
                ['6', '21ASP75', 'Project Work', a[5], b[5], gpl[5], lgl[5], b[5] * gpl[5]],
