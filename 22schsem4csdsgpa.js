function calculate() {
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', 'BCS401', 'Analysis & Design of Algorithms', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', 'BCG402', 'Computer Graphics and Visualization', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
