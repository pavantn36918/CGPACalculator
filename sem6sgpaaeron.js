function calculate() {
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', '21AE61', 'Aviation Management', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', '21AE62', 'Aircraft Systems and Avionics', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', '21AE63', 'Gas Turbine Technology', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', '21AE64x', 'Professional Elective Course-I', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', '21AE65x', 'Open Elecvtive Course-I', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
                ['6', '21AEL66', 'Flight Modelling, Analysis and Simulation Laboratory', a[5], b[5], gpl[5], lgl[5], b[5] * gpl[5]],
                ['7', '21AEMP67', 'Mini Project', a[6], b[6], gpl[6], lgl[6], b[6] * gpl[6]],
