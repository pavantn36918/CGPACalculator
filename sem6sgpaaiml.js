    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ...
                ['2', '21AD62', 'Data Science and its Applications', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', '21AI63', 'Machine Learning', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', '21XX64x', 'Professional Elective Course-I', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', '21XX65x', 'Open Elecvtive Course-I', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
                ['6', '21AIL66', 'Machine learning Laboratory', a[5], b[5], gpl[5], lgl[5], b[5] * gpl[5]],
                ['7', '21AIMP67', 'Mini Project', a[6], b[6], gpl[6], lgl[6], b[6] * gpl[6]],
