function calculate() {
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', 'BAE401', 'Aero Engineering Thermodynamics', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', 'BAE402/BAS402', 'Aerodynamics', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', 'BAE403', 'Aircraft Propulsion', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', 'BAEL404', 'Aircraft Material Testing & Processing Lab', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', 'BAE405x', 'ESC / ETC / PLC', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
                ['6', 'BAE456x', 'Ability Enhancement Course', a[5], b[5], gpl[5], lgl[5], b[5] * gpl[5]],
                ['7', 'BBOK407', 'Biology For Engineers', a[6], b[6], gpl[6], lgl[6], b[6] * gpl[6]],
        ...
        const y1 = 220;  // Y-position for the text
