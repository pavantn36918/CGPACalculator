function calculate() {
    ...
    let heading = '6th SEM GRADE REPORT';
    ...
    document.getElementById('download-btn').addEventListener('click', function () {
        ...
        doc.autoTable({
            ...
            body: [
                ['1', '21CV61', 'Construction Management and Enterprenurship', a[0], b[0], gpl[0], lgl[0], b[0] * gpl[0]],
                ['2', '21CV62', 'Concrete Technology', a[1], b[1], gpl[1], lgl[1], b[1] * gpl[1]],
                ['3', '21CV63', 'Design of Steel Structures', a[2], b[2], gpl[2], lgl[2], b[2] * gpl[2]],
                ['4', '21CV64x', 'Professional Elective Course-I', a[3], b[3], gpl[3], lgl[3], b[3] * gpl[3]],
                ['5', '21CV65x', 'Open Elecvtive Course-I', a[4], b[4], gpl[4], lgl[4], b[4] * gpl[4]],
                ['6', '21CVL66', 'Computer Aided Detailing of Structures', a[5], b[5], gpl[5], lgl[5], b[5] * gpl[5]],
                ['7', '21CVMP67', 'Mini Project', a[6], b[6], gpl[6], lgl[6], b[6] * gpl[6]],
        ...
        doc.save("6th sem grade report.pdf");
